...
Statistics::Print()
{
    ...
    printf("Paging: faults %lu, \"hits\": %lu, real hits: %lu, hit ratio: %.3f%%\n", numPageFaults, numPageHits, numPageHits-numPageFaults, ((double)(numPageHits-numPageFaults) / (numPageHits)) * 100);
